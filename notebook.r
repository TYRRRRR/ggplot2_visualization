...
plt_cum_confirmed_cases_china_vs_world <- ggplot(confirmed_cases_china_vs_world) +
  geom_line(aes(x=as.Date(date),y=cum_cases,group = factor(is_china), color = factor(is_china))) +
  ylab("Cumulative confirmed cases")+
  scale_x_date(date_breaks = "1 week", date_labels = "%b %d")+
  theme_classic()
...
plt_cum_confirmed_cases_china_vs_world +
  geom_vline(xintercept =who_events$date[1],color = "grey40", linetype = 3,size = 1) +
  geom_vline(xintercept =who_events$date[2],color = "grey40", linetype = 3,size = 1) +
  geom_vline(xintercept =who_events$date[3],color = "grey40", linetype = 3,size = 1) +
  geom_text( aes(x =who_events$date[1],y=10000, label=who_events$event[1]),color="black")+
  geom_text( aes(x =who_events$date[2],y=10000, label=who_events$event[2]),color="black")+
  geom_text( aes(x =who_events$date[3],y=10000, label=who_events$event[3]),color="black") 
